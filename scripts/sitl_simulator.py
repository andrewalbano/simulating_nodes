...
from geometry_msgs.msg import TwistStamped, PoseWithCovarianceStamped, Point, PoseStamped, Twist, TwistWithCovarianceStamped
...
class kinematic_simulator:
    def __init__(self):
        ...
        self.velocity = TwistWithCovarianceStamped()
        # self.velocity_x = 0.1
        # self.velocity_y = 0.1
        # self.velocity_z = 0.0
        ...
        self.pub3 = rospy.Publisher('/twist',TwistWithCovarianceStamped, queue_size=queue_size)
    ...
    def publish_velocity(self):
        ...
        self.velocity.header.frame_id = "base_link"
        self.velocity.twist.twist.linear.x = self.vx
        self.velocity.twist.twist.linear.y = self.vy
        self.velocity.twist.twist.linear.z = self.vz
        self.velocity.twist.twist.angular.x = 0
        self.velocity.twist.twist.angular.y = 0
        self.velocity.twist.twist.angular.z = self.vyaw
        self.pub3.publish(self.velocity)
